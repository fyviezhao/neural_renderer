...
class TestRasterize(unittest.TestCase):
    def test_forward_case1(self):
        ...
        # load teapot
        vertices, faces, textures = utils_dongxin.load_teapot_batch()
    ...
    def test_backward_case1(self):
        ...
        vertices, faces, textures, grad_ref = utils_dongxin.to_minibatch((vertices, faces, textures, grad_ref))
